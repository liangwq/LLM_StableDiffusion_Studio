...
CONTROLNET_MODEL_IDS = {
    ...
    'depth':'/root/autodl-tmp/dream_studio/contrl_model/control_v11f1p_sd15_depth',
...
class Model:
    def __init__(self,
                 ...
                 base_model_id: str ='dreamlike-art/dreamlike-photoreal-2.0',
                 task_name: str = 'Canny'):
