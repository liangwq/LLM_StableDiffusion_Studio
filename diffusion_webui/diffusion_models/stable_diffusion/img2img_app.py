...
class StableDiffusionImage2ImageGenerator:
    ...
    def load_model(self, model_path, scheduler):
        if self.pipe is None:
            self.pipe = StableDiffusionImg2ImgPipeline.from_pretrained(model_path, safety_checker=None, torch_dtype=torch.float16,cache_dir='./sd_model')
    ...
    def app():
        ...
        image2image_model_path.select(
                fn=StableDiffusionImage2ImageGenerator().image_model_path_change,
                inputs=[
